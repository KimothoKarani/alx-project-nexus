...
schema_view = get_schema_view(
    openapi.Info(
        ...
        default_version='v1',
        description="Backend API for an E-commerce product catalog, handling product data management, user authentication, and APIs for filtering, sorting, and pagination.",
        terms_of_service="https://www.google.com/policies/get/terms/",
        contact=openapi.Contact(email="contact@bustboredom.com"),
